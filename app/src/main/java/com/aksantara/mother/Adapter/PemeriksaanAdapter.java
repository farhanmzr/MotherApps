...
public class PemeriksaanAdapter extends FirestoreAdapter<PemeriksaanAdapter.ViewHolder> {

    private OnProductSelectedListener mListener;

    public PemeriksaanAdapter(Query query, PemeriksaanAdapter.OnProductSelectedListener listener) {
        super(query);
        mListener = listener;
    }
    ...
    public PemeriksaanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PemeriksaanAdapter.ViewHolder(inflater.inflate(R.layout.item_rv_riwayat, parent, false));
    }
